...
| [`docs/RELEASE_NOTES_v0.4.0.md`](docs/RELEASE_NOTES_v0.4.0.md) | v0.4.0 发布说明、升级注意事项 |
...
**0.4.0** —— Workbench 与解析器版本。Paperindex 支持可选 Docling 后端，公共 Workbench / 文档围绕核心科研循环重新整理，本地 release checks 覆盖 Ruff format、解析器测试、web lint/tests/build。版本说明见 [`CHANGELOG.md`](CHANGELOG.md)。
