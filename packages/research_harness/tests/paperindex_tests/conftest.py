...
# These tests were moved from packages/paperindex/tests/ and assume no
# parent-level LLM stubbing. The parent tests/conftest.py installs an
# autouse `_stub_paperindex_llm_chat` fixture for card-extraction path
# tests elsewhere, but it defeats the targeted monkey-patches these
# tests set up themselves. Override to a no-op here.
@pytest.fixture(autouse=True)
def _stub_paperindex_llm_chat():
    yield
