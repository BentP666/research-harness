...
from research_harness.paperindex.library import PaperLibrary
from research_harness.paperindex.retrieval import (
    find_structure_matches,
    search_catalog,
    search_records,
)
from research_harness.paperindex.retrieval.rerankers import _extract_ranked_items
