...
from research_harness.paperindex.cards import PaperCard
    ...
    return json.dumps(
        {
            ...
            "method_pipeline": [
                ...
                "Replay on offline logs",
            ],
            "method_family": "optimization_based",
            "method_tags": ["budget pacing", "constrained optimization"],
            "contributions": [
                "Introduces a stable pacing controller",
                "Shows offline gains over baselines",
            ],
            ...
            "evidence": [
                {
                    "section": "experiments",
                    "confidence": 0.83,
                    "snippet": "improve efficiency by 12 percent",
                }
            ],
            "structured_results": [
                {
